...
mixin ZegoVideoConferenceRoomControllerLog {
  final _logImpl = ZegoVideoConferenceRoomControllerLogImpl();

  ZegoVideoConferenceRoomControllerLogImpl get log => _logImpl;
}

/// Here are the APIs related to user
class ZegoVideoConferenceRoomControllerLogImpl {
  /// export logs
  ///
